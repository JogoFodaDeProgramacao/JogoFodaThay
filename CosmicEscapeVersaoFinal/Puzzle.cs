    ...
    class Puzzle
    {
        ...
        public void BuscarArtefatos(Astronauta astro)
        {
           if (astro.Estamina >= 30)
           {
                ...
                colorido.AmareloR("OBS 1 : Buscar artefatos custa inicialmente 30 de estamina");
                colorido.AmareloR("OBS 2 : Caso ache um artefato, perderá mais 10 de estamina voltando para a base");
                colorido.AmareloR("OBS 3 : Caso NÃO ache um artefato, perderá mais 20 de estamina voltando para a base");
                colorido.AmareloR("OBS 4 : As regiões são desbloqueadas por hierarquia, começando pela região 1");
                colorido.AmareloR("OBS 5 : Sempre que iniciar a ação Buscar Artefatos, a posição deles será trocada aleatoriamente");
                Console.WriteLine(string.Empty);
                colorido.Ciano("Em que região deseja procurar?");
                colorido.CinzaR("[1] - Montanhas de sulfato");
                colorido.CinzaR("[2] - Vale pedregoso");
                colorido.CinzaR("[3] - Caverna de chumbo");
                colorido.CinzaR("[4] - Canyon de ametista");
                colorido.CinzaR("[5] - Rio de mercúrio");
